...
var sprite_sheet: Texture: get = get_sprite_sheet ## Armor's spritesheet
var icon: Texture: get = get_icon ## Icon of the armor
...
func initialize(condition: int, ability_icon: Texture = null, recharge_time: float = 2, effect_duration: float = -1) -> void:
