...
func can_pick_up(player: Player) -> bool:
	return not player.weapons.current_weapon is Dagger and player.weapons.current_weapon.stats.get_amount_of_modifiers() < MAX_AMOUNT_OF_STATUS_MODIFIERS_PER_WEAPON
