...
func _ready() -> void:
	...
	SavedData.data_loaded.connect(_on_data_loaded, CONNECT_ONE_SHOT)
...
func _on_data_loaded() -> void:
	...
	SavedData.add_extra_available_permanent_artifact("res://mods-unpacked/WekufuStudios-DemoMod/anti_acid_ring.gd")
