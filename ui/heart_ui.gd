...
#const TEXTURES: Array[AnimatedTexture] = [preload("res://Art/16x16 Pixel Art Roguelike (Forest) Pack/ui/Heart fraction anims/heart_smol_0-4_animation.tres"), preload("res://Art/16x16 Pixel Art Roguelike (Forest) Pack/ui/Heart fraction anims/heart_smol_1-4_animation.tres"), preload("res://Art/16x16 Pixel Art Roguelike (Forest) Pack/ui/Heart fraction anims/heart_smol_2-4_animation.tres"), preload("res://Art/16x16 Pixel Art Roguelike (Forest) Pack/ui/Heart fraction anims/heart_smol_3-4_animation.tres"), preload("res://Art/16x16 Pixel Art Roguelike (Forest) Pack/ui/small_heart_animation.tres")]
